...
This repository contains code related to general manipulation of the SDO HMI dataset ([https://doi.org/10.5061/dryad.qjq2bvqmj](https://doi.org/10.5061/dryad.qjq2bvqmj)) and the use of that for two machine learning problems for flare prediction: 1) a classical machine learning problem using extracted features of magnetic complexity and a support vector machine (SVM) classifier and 2) a deep learning problem using transfer learning on the VGG network.
