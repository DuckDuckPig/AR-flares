...
underneath the specified event_directory variable set at the beginning of this
...
## User Definitions
event_directory = '/mnt/solar_flares/AR_Dataset/' # directory underneath which the Events/ directory resides
file_directory = './' # directory into which to write eventList.txt
## End User Definitions

Events_dirs = sorted(glob.glob(event_directory+'Events/*')) #list of Events directories
fwrite = open(file_directory+'/eventList.txt','w+')
